...
1. Please make sure there is no [open issue](https://github.com/oscard0m/octoherd-script-create-issue/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/octoherd-script-create-issue.git
cd octoherd-script-create-issue
npm install
```
...
- Submit a pull request from your topic branch to the main branch on the `oscard0m/octoherd-script-create-issue` repository.
